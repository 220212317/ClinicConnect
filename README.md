...
Navigate to where the file is (cloned repo). Umzekelo, if you cloned it to desktop, uzokwenza kanje:
cd Desktop
cd ClinicConnect
npm install
```
...
First download and install Expo Go 55 (I used SDK 55) then run this command:
